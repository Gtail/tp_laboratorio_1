...
void operar(int num1, int num2, int *sumatoria, int *resta, float *division, int *multiplicacion, long int *factorizar, long int *factorizar2){
...
void mostrar(int num1, int num2,int sumatoria, int resta, float division, int multiplicacion, long int factorizar, long int factorizar2){
	...
	printf("\n El resultado del factoreo del primer numero %d es %ld\n\n",num1, factorizar);
	printf("\n El resultado del factoreo del segundo numero %d es %ld\n\n",num2, factorizar2);
	}
}

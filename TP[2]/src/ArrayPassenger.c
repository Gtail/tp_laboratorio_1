...
int alta_Forzada(Passenger list[], int tam, int cant, int* idAuto)
{

    int todoOk = 0;
    Passenger pasajeros[] =
    {
        {0, "Juan", "Franzoso", "C203",   10000 ,1,1,1},
        {0, "Daniela", "Gimenez", "C204", 12000 ,3,1,0},
        {0, "Lucia", "Camuzo", "C205",    40000  ,2,1,1},
        {0, "Mauro", "Gonzalez", "C206",  23200 ,1,1,0},
        {0, "Diego", "Torres", "C207",    12000  ,2,1,1},
        {0, "Juana", "Estebanez", "C208", 13000 ,3,1,1},
        {0, "Miguel", "Coccioli", "C209", 12000 ,2,1,0},
        {0, "Luciano", "Granero", "C210", 15000,1,1,1},
        {0, "Marina", "Armani", "C211",   12000 ,3,1,0},
        {0, "Dalma", "Maradona", "C212",  11000 ,2,1,1}
    	/*int id;
    	char name[51];
    	char lastName[51];
    	char flycode[10]; //PK
